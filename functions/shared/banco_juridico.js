...
// ── Jurisdição: importado de jurisdicao.js (fonte única de verdade) ──
const {
  PERFIL_TRIBUNAL, CADEIA_INSTANCIAS, ENTES_TRIBUTARIOS_ESTADUAIS,
  tribunalRecursal, ehTopoDaCadeia,
} = require('./jurisdicao');
...
const { XP_BASE_INSTANCIA, xpPorDecisao } = require('./jurisdicao');
...
// ════════════════════════════════════════════════════════
// EXPORTS — versão CommonJS deste módulo, usada pela Cloud Function
// (processar_sentenca.js). Mesmo conteúdo jurídico que
// js/shared/banco_juridico.js (frontend, ES Module) — ver aviso de
// sincronização manual lá.
// ════════════════════════════════════════════════════════
module.exports = {
  gerarProcesso,
  gerarTextoLocal,
